...
* [`src/judict/`](src/judict/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/judict/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `judict` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/judict/config.cljs) defaults to `true` in
...
```clj
(ns judict.example
  (:require [judict.config :as config])
